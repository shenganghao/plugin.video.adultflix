...
@local_utils.url_dispatcher.register('0')
def mainMenu():
    ...
    c += [
        (
            kodi.giveColor('Welcome to AdultFlix Version %s' % kodi.get_version(), 'blue', True),
            xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/information.txt')), 17, 'icon',
        ...
        (
            kodi.giveColor(
                kodi.countGitHubIssues('https://github.com/tvaddonsco/plugin.video.adultflix/issues'), 'blue', True
        ...
        ,
        (
            kodi.giveColor('Report Issues @ https://github.com/tvaddonsco/plugin.video.adultflix/issues', 'violet', True),
            xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/information.txt')), 17, 'report',
            'All issues must be reported at https://github.com/tvaddonsco/plugin.video.adultflix/issues or I will not know the issues exist. '
            'I will not provide support at any other location as one central place for everyone to see and discuss issues benefits everyone.',
            False
        )
