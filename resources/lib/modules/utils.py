...
def depVersions():
    ...
    try:
        ...
        lst = [('plugin.video.adultflix'),('script.adultflix.scrapers'),('script.adultflix.artwork'), \
...
class TextBox(pyxbmct.AddonDialogWindow):
    ...
    def set_info_controls(self):
        ...
        Background   = pyxbmct.Image(xbmc.translatePath(os.path.join('special://home/addons/script.adultflix.artwork', 'resources/art/dialog/bg.jpg')))
